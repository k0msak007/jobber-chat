...
import { IConversationDocument, IMessageDetails, IMessageDocument, lowerCase } from '@k0msak007/jobber-shared';
...
const markManyMessageAsRead = async (receiver: string, sender: string, messageId: string): Promise<IMessageDocument> => {
