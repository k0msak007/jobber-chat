...
import { BadRequestError, IMessageDocument, uploads } from '@k0msak007/jobber-shared';
import { NextFunction, Request, Response } from 'express';
import { UploadApiResponse } from 'cloudinary';
import { addMessage, createConversation } from '@chat/services/message.service';
import { StatusCodes } from 'http-status-codes';

const message = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
